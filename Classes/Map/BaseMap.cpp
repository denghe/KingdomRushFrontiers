...
void BaseMap::loadPathFromPlist()
{
	...
	auto plistDic = Dictionary::createWithContentsOfFile(
		__String::createWithFormat("level%d_paths.plist", getLevel())->getCString());
...
void BaseMap::initMap()
{
	...
	mapSprite = Sprite::createWithSpriteFrameName(__String::createWithFormat("Stage_%d.png", level + 1)->getCString());
