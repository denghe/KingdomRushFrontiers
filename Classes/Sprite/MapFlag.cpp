...
void MapFlag::initStar()
{
	...
	{
		frame = SpriteFrameCache::getInstance()->getSpriteFrameByName(__String::createWithFormat("mapFlag_star_00%02d.png",len)->getCString());
...
void MapFlag::startDropdownAnimation()
{
	...
	for (int len = 1; len <= 22; len++)
	{
		frame = SpriteFrameCache::getInstance()->getSpriteFrameByName(
			__String::createWithFormat("mapFlag_0%03d.png", len)->getCString());
...
void MapFlag::startSuccessAnimation()
{
	...
	{
		frame = SpriteFrameCache::getInstance()->getSpriteFrameByName(__String::createWithFormat("mapFlag_0%03d.png",len)->getCString());
