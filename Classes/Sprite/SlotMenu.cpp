...
bool SlotMenu::initWithNum(int num)
{
	...
	if(UserDefault::getInstance()->getIntegerForKey(__String::createWithFormat("Slot%d",getNum())->getCString(),0)==0)
	{
		createNewGame();
	...
	}else
	{
		...
		auto label_slot = Label::createWithTTF(__String::createWithFormat("SLOT %d",num)->getCString(),"Comic_Book.ttf",32,Size::ZERO,TextHAlignment::LEFT,TextVAlignment::TOP);
		...
		int starCountInt = UserDefault::getInstance()->getIntegerForKey(__String::createWithFormat("Slot%d_Star",getNum())->getCString(),0);

		auto slot = Label::createWithTTF(__String::createWithFormat("%d/65",starCountInt)->getCString(),"Comic_Book.ttf",32,Size::ZERO,TextHAlignment::LEFT,TextVAlignment::TOP);
...
{
	UserDefault::getInstance()->setIntegerForKey(__String::createWithFormat("Slot%d",getNum())->getCString(),0);

	for(int i=0;i<13;i++)
	{
		UserDefault::getInstance()->setIntegerForKey(__String::createWithFormat("Slot%d_Level_%d",getNum(),i)->getCString(),0);
	}

	for(int i=0;i<13;i++)
	{
		UserDefault::getInstance()->setIntegerForKey(__String::createWithFormat("Slot%d_Level_%d_star",getNum(),i)->getCString(),0);
	}

	UserDefault::getInstance()->setIntegerForKey(__String::createWithFormat("Slot%d_DownCount",getNum())->getCString(),0);
 
	UserDefault::getInstance()->setIntegerForKey(__String::createWithFormat("Slot%d_NewDown",getNum())->getCString(),0);

	UserDefault::getInstance()->setIntegerForKey(__String::createWithFormat("Slot%d_StarLeft",getNum())->getCString(),0);

	UserDefault::getInstance()->setIntegerForKey(__String::createWithFormat("Slot%d_Star",getNum())->getCString(),0);

	UserDefault::getInstance()->setIntegerForKey(__String::createWithFormat("Slot%d_Gem",getNum())->getCString(),0);

	for(int i = 0;i<6;i++){
		UserDefault::getInstance()->setIntegerForKey(__String::createWithFormat("Slot%d_Shop_%d",getNum(),i)->getCString(),0);
	}
}